...
excerpt: "Ant Design's Upload component is packed full of features. When it comes to uploading to an AWS S3 bucket using a signed request, there's obvious lack of docu..."
---
