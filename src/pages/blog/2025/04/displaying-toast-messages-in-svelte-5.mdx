...
excerpt: "Toast messages are a lovely addition to any interface whether it's your Operating System, mobile or web application. There are decent articles that explain how and why to implement them."
---
