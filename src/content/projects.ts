export const projects = [
	{
		...
		description:
			'A professional website for Williamstown Soccer Club in Melbourne, Victoria. The site showcases the club, provides fixture information, news updates, and engages with the local soccer community. Replaced an outdated Wordpress website. Launched in 2026 at www.williamstownsc.com.',
		businessMetrics: [
			'Clean, modern design representing the club brand',
			'Live match countdown timer showing next fixture and venue',
			'Content management system for news and updates via Sanity CMS',
			...
			'SEO optimized with schema markup for local searches',
			'Sponsors showcase section with six major partners',
			'Google Maps integration for home ground location',
	...
	},
	{
		...
		testimonial: {
			quote:
				'Dejan helped us create a professional website that truly represents our carpentry and building services. His expertise in web development and SEO has significantly improved our online presence, making it easier for potential clients to find us. The website is user-friendly and visually appealing, which has helped us attract more business. We highly recommend his services!',
			author: 'John from JLC Carpentry & Building Services'
		},
		tags: ['Nextjs', 'Sanity CMS', 'Tailwind', 'Vercel'],
	...
	},
	{
		...
		businessMetrics: [],
		testimonial: null,
		tags: ['Astro', 'MDX', 'Tailwind', 'Vercel'],
		projectUrl: 'https://dejan.vasic.com.au',
		sourceCodeUrl: 'https://github.com/dejanvasic85/portfolio',
		images: {
			desktop: null,
			mobile: null
